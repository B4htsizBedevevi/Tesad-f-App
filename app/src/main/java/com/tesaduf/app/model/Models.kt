...
@Serializable data class MatchResponse(
    val match:Match?=null,val partner_anonymous_id:String?=null,
    val matched:Boolean?=null,val reused:Boolean?=null,val error:String?=null
)
...
@Serializable data class ChatsResponse(val chats:List<ChatItem> = emptyList(),val error:String?=null)
@Serializable data class ChatItem(val id:String,val mode:String,val status:String,val partner:Partner,val created_at:String)
@Serializable data class Partner(val anonymous_id:String?=null,val status:String?=null)
@Serializable data class ActionResponse(val ok:Boolean=false,val error:String?=null)
