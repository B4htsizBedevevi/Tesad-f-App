...
class MainActivity : Activity() {
    ...
    private fun baseRoot()=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;background=GradientDrawable(GradientDrawable.Orientation.TL_BR,intArrayOf(Color.rgb(7,9,20),Color.rgb(10,9,27),Color.rgb(7,9,20)))}
    ...
    private fun roundedCard()=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;setPadding(dp(20),dp(20),dp(20),dp(20));elevation=dp(6).toFloat();background=GradientDrawable().apply{setColor(card);cornerRadius=dp(26).toFloat();setStroke(dp(1),Color.rgb(37,42,72))}}
    ...
    private fun primaryButton(text:String)=Button(this).apply{this.text=text;setTextColor(white);textSize=15f;isAllCaps=false;elevation=dp(8).toFloat();background=GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT,intArrayOf(Color.rgb(30,190,255),Color.rgb(105,91,255),Color.rgb(240,55,205))).apply{cornerRadius=dp(26).toFloat();setStroke(dp(1),Color.argb(90,255,255,255))}}
}
